...
DadosTabelaTesting = removevars(DadosTabelaTesting, [1]);
DadosTabelaTesting = removevars(DadosTabelaTesting, [1]);
DadosTabelaTesting = removevars(DadosTabelaTesting, [3]);

DadosTabelaTraining = removevars(DadosTabelaTraining, [1]);
DadosTabelaTraining = removevars(DadosTabelaTraining, [1]);
DadosTabelaTraining = removevars(DadosTabelaTraining, [3]);

DadosTabelaCheckingGroup1 = removevars(DadosTabelaCheckingGroup1, [1]);
DadosTabelaCheckingGroup1 = removevars(DadosTabelaCheckingGroup1, [1]);
DadosTabelaCheckingGroup1 = removevars(DadosTabelaCheckingGroup1, [3]);

DadosTabelaCheckingGroup2 = removevars(DadosTabelaCheckingGroup2, [1]);
DadosTabelaCheckingGroup2 = removevars(DadosTabelaCheckingGroup2, [1]);
DadosTabelaCheckingGroup2 = removevars(DadosTabelaCheckingGroup2, [3]);

DadosTabelaCheckingGroup3 = removevars(DadosTabelaCheckingGroup3, [1]);
DadosTabelaCheckingGroup3 = removevars(DadosTabelaCheckingGroup3, [1]);
DadosTabelaCheckingGroup3 = removevars(DadosTabelaCheckingGroup3, [3]);

DadosTabelaCheckingGroup4 = removevars(DadosTabelaCheckingGroup4, [1]);
DadosTabelaCheckingGroup4 = removevars(DadosTabelaCheckingGroup4, [1]);
DadosTabelaCheckingGroup4 = removevars(DadosTabelaCheckingGroup4, [3]);

DadosTabelaCheckingGroup5 = removevars(DadosTabelaCheckingGroup5, [1]);
DadosTabelaCheckingGroup5 = removevars(DadosTabelaCheckingGroup5, [1]);
DadosTabelaCheckingGroup5 = removevars(DadosTabelaCheckingGroup5, [3]);

DadosTabelaCheckingGroup1234 = removevars(DadosTabelaCheckingGroup1234, [1]);
DadosTabelaCheckingGroup1234 = removevars(DadosTabelaCheckingGroup1234, [1]);
DadosTabelaCheckingGroup1234 = removevars(DadosTabelaCheckingGroup1234, [3]);

DadosTabelaCheckingGroup1235 = removevars(DadosTabelaCheckingGroup1235, [1]);
DadosTabelaCheckingGroup1235 = removevars(DadosTabelaCheckingGroup1235, [1]);
DadosTabelaCheckingGroup1235 = removevars(DadosTabelaCheckingGroup1235, [3]);

DadosTabelaCheckingGroup1245 = removevars(DadosTabelaCheckingGroup1245, [1]);
DadosTabelaCheckingGroup1245 = removevars(DadosTabelaCheckingGroup1245, [1]);
DadosTabelaCheckingGroup1245 = removevars(DadosTabelaCheckingGroup1245, [3]);

DadosTabelaCheckingGroup1345 = removevars(DadosTabelaCheckingGroup1345, [1]);
DadosTabelaCheckingGroup1345 = removevars(DadosTabelaCheckingGroup1345, [1]);
DadosTabelaCheckingGroup1345 = removevars(DadosTabelaCheckingGroup1345, [3]);

DadosTabelaCheckingGroup2345 = removevars(DadosTabelaCheckingGroup2345, [1]);
DadosTabelaCheckingGroup2345 = removevars(DadosTabelaCheckingGroup2345, [1]);
DadosTabelaCheckingGroup2345 = removevars(DadosTabelaCheckingGroup2345, [3]);
